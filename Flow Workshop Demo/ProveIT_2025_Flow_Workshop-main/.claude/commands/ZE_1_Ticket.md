...
### Step 8: Present completion summary to user
...
- Type: [bug|feature|debt]
- Priority: [high|medium|low]
- Location: {solution}/thoughts/tickets/[filename].md
- Status: created
...
Research Hooks:
- Keywords: [list top 3-5 keywords]
- Patterns: [list top 2-3 patterns]

NEXT STEP: Begin research phase
Copy and run: /ZE_2_Research {solution} thoughts/tickets/[filename].md
```
